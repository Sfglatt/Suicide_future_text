...
```{r Github}
# usethis::create_from_github("https://github.com/Sfglatt/Suicide_future_text.git",
...
```{r Data}
# Import transcript
Transcript_doc <- read_docx("Transcripts/P2_Transcript.docx")
...
# add suicidal identifier. I'm programming that IDs under 95 are suicidal and IDs 95 and higher are non-suicidal. This will make a 'group' variable with this information:
