...
(bing_plot <- bing_word_counts %>%
  ...
  labs(x = "Contribution to sentiment",
       y = NULL,
       title = "Words contributing to sentiment by group (S/NS)") +
  scale_y_reordered() +
  theme_minimal() +
  theme(
    panel.grid.major = element_line(color = "grey"),
...
(nrc_plot <- nrc_word_counts %>%
  ...
  labs(x = "Contribution to sentiment",
       y = NULL,
       title = "Top words contributing to sentiment by group (S/NS)") +
  scale_y_reordered() +
  theme_minimal() +
  theme(
    panel.grid.major = element_line(color = "grey"),
...
(ggplot(average_sentiment_nrc_long, aes(x = sentiment, y = average_score, fill = group)) +
...
(ggplot(average_sentiment_bing_long, aes(x = sentiment, y = average_score, fill = group)) +
  geom_col(position = "dodge") +
...
(negation_sentiment_plot_afinn <- negation_sentiment_words %>%
  ...
  labs(x = "Frequency", y = NULL, title = "Top words following negation words by group") +
  scale_y_reordered() +
  theme_minimal() +
  theme(
    panel.grid.major = element_line(color = "grey"),
